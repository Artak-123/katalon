...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Admin Portal/div_Login Successful'), 0)

WebUI.click(findTestObject('Object Repository/Page_Admin Portal/i_Dashboard_pi icon icon-arrow_left'))

WebUI.click(findTestObject('Object Repository/Page_Admin Portal/a_Dashboard'))

WebUI.click(findTestObject('Object Repository/Page_Admin Portal/div_120K 25'))

WebUI.click(findTestObject('Object Repository/Page_Admin Portal/div_Bets40K 34'))

WebUI.click(findTestObject('Object Repository/Page_Admin Portal/span_GGR - 19_p-button-icon icon-fast-search'))
